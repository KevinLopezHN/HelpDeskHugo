          ...
          <div css={UIComponentStyle()}>
            <div css={boxStyle()}>
              <div css={titleWrapperStyle()}>
                ...
                <h2 css={componentTitleStyle()}>Comunicate con un agente de servicio al cliente</h2>
              </div>
              <div css={descWrapperStyle()}>
                <p>Resuelve <code>todas tus necesidades</code> en tiempo real</p>
              </div>
              <ul css={linkWrapperStyle()}>
                <li><Link css={linkStyle()} to="/embedded-app">Aceptar</Link></li>
              </ul>
            </div>
          </div>
...
{/* 
        ...
        <div css={logoutBtn()}><button type="button" onClick={this.props.onLogout}>Desconectar</button></div>
        </div>
    );
  }
}
