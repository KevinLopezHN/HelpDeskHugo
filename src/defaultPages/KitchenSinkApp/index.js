...
class KitchenSinkApp extends React.PureComponent {
  ...
  render() {
    ...
    if (this.props.loading) {
      loader = (<div className="loading">Cargando...</div>);
    }
    ...
    return (
      ...
      <div css={wrapperStyle()}>
          ...
          {loader}
          {errorMessage}
          <p css={titleStyle()}>HelpDesk Hugo</p>
          ...
          <div css={uidWrapperStyle()}>
            <div>
              <p css={subtitleStyle()}>Login con identificacion</p>
            </div>
            <div css={inputWrapperStyle()}>
              <input ref={this.myRef} type="text" placeholder="Ingresa tu identificacion aqui" />
            </div>
